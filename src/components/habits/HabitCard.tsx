...
export const HabitCard: React.FC<HabitCardProps> = ({ habit, log, onToggle, getStreak }) => {
  ...
  return (
    <motion.button
      whileTap={{ scale: 0.97 }}
      onClick={onToggle}
      className={`glass-card p-3 flex items-center gap-3 w-full text-left transition-all duration-200 ${
